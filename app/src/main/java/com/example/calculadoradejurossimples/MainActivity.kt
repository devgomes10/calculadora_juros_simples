...
import com.example.calculadoradejurossimples.fees.FeesScreen
import com.example.calculadoradejurossimples.fees.FeesScreenViewModel
        ...
        setContent {
            CalculadoraDeJurosSimplesTheme {
                ...
                Surface(
                    ...
                    FeesScreen(FeesScreenViewModel())
                }
            }
        }
    }
